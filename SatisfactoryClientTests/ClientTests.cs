...
namespace SatisfactoryClientTests
{
    public class ClientTests
    {
        ...
        {
            HttpsClient client = new HttpsClient("127.0.0.1");
        ...
        {
            HttpsClient client = new HttpsClient("127.0.0.1", port: 7878);
        ...
        public void UsePort()
        {
            HttpsClient client = new HttpsClient("127.0.0.1", usePort: false);
        ...
        public void AuthToken()
        {
            ...
            HttpsClient client = new HttpsClient("127.0.0.1", client: httpClient, authToken: "TEST1234");
            Assert.That(client.FullConnectionString, Is.EqualTo("https://127.0.0.1:7777/api/v1"));
        ...
        {
            Assert.Throws<InvalidDataException>(() => new HttpsClient("127.0.0.1", port: 99999));
        }
        ...
        {
            HttpClient httpClient = new HttpClient();
            HttpsClient client = new HttpsClient("127.0.0.1", client: httpClient);
